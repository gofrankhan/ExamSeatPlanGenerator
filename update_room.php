...
if(isset($_POST['form_room'])) {
	...
	try {
		...
		$statement = $db->prepare("update tb_block_room set room_no=? where room_no=?");
		$statement->execute(array($_POST['room_no'],$room_no));
		
		$statement = $db->prepare("update tb_rooms set room_no=?,col_1=?,col_2=?,col_3=?,col_4=?,col_5=?,col_6=?,col_7=?,col_8=?,col_9=?,building_no=? where r_id=?");
		$statement->execute(array($_POST['room_no'],$_POST['col_1'],$_POST['col_2'],$_POST['col_3'],$_POST['col_4'],$_POST['col_5'],$_POST['col_6'],$_POST['col_7'],$_POST['col_8'],$_POST['col_9'],$_POST['building_no'],$id));
...
<html lang="en">
  <head>
    ...
    <title>Update Room::Exam Hall Manager</title>
  ...
  <div class="container-fluid">
	...
	<!-- lEFT LIST START -->
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
					  <ul class="nav navbar-nav">
						...
						<li class="active"> <a href="insert_room_info.php">Update room <span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon "></span></a>        
			...
			<?php
				...
				$statement = $db->prepare("select * from tb_rooms where r_id=?");
				$statement->execute(array($id));
				$result = $statement->fetchAll(PDO::FETCH_ASSOC);
				foreach($result as $row)
				{
		...
		?>
			...
			<div class="panel-heading">Update Room Info.</div>
			<div class="panel-body">
				<form action="" method="post">
				<div class="form-group row">
				  <label for="example-text-input" class="col-xs-3 col-form-label">Room No.</label>
				  <div class="col-xs-12">
					<input class="form-control" type="text" name="room_no" value="<?php echo $room_no;?>" id="example-text-input">
				  </div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-xs-4">
					<input class="form-control" type="number" name="col_1" value="<?php echo $col_1;?>" id="example-text-input">
				  </div>
				  <div class="col-xs-4">
					<input class="form-control" type="number" name="col_2" value="<?php echo $col_2;?>" id="example-text-input">
				  </div>
				  <div class="col-xs-4">
					<input class="form-control" type="number" name="col_3" value="<?php echo $col_3;?>" id="example-text-input">
				  </div>
				  </div>
				<div class="form-group row">
					<label for="example-text-input" class="col-xs-12 col-form-label" ></label>
				  <div class="col-xs-4">
					<input class="form-control" type="number" name="col_4" value="<?php echo $col_4;?>" id="example-text-input">
				  </div>
				  <div class="col-xs-4">
					<input class="form-control" type="number" name="col_5" value="<?php echo $col_5;?>" id="example-text-input">
				  </div>
				   <div class="col-xs-4">
					<input class="form-control" type="number" name="col_6" value="<?php echo $col_6;?>" id="example-text-input">
				  </div>
				  </div>
				 <div class="form-group row">
					<label for="example-text-input" class="col-xs-12 col-form-label" ></label> 
				  <div class="col-xs-4">
					<input class="form-control" type="number" name="col_7" value="<?php echo $col_7;?>" id="example-text-input">
				  </div>
				  <div class="col-xs-4">
					<input class="form-control" type="number" name="col_8" value="<?php echo $col_8;?>" id="example-text-input">
				  </div>
				   <div class="col-xs-4">
					<input class="form-control" type="number" name="col_9" value="<?php echo $col_9;?>" id="example-text-input">
				  </div>
				</div>
						
				
				<div class="form-group row">
				  <label for="example-text-input" class="col-xs-7 col-form-label">Building<small>(DT5, CSEB, AB and MC only)</small></label>
				  <div class="col-xs-12">
					<input class="form-control" type="text" name="building_no" value="<?php echo $building_no;?>" id="example-text-input">
				  </div>
				</div>
				</div>
				</div>
				<div class="form-group">
				<button for="example-time-input" type="submit" name="form_room"class="col-xs-3 btn btn-success">Update</button>
				</div>
				</form>
			</div>
