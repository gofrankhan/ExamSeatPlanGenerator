...
if(isset($_POST['form_routine'])) {
	...
	try {
		...
		$statement = $db->prepare("update tb_routine set course_title=?,course_id=?,batch_no=?,date=?,slot=?,start_time=?, end_time=? where ID=?");
		$statement->execute(array($_POST['course_title'],$_POST['course_id'],$_POST['batch_no'],$_POST['date'],$_POST['slot'],$_POST['start_time'],$_POST['end_time'],$id));
...
<html lang="en">
  <head>
    ...
    <title>Update Routine::Exam Hall Manager</title>
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
					  <ul class="nav navbar-nav">
						...
						<li class="active"><a href="insert_routine.php">Update Routine<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon "></span></a></li>        
		...
		?>
			...
			<form action="" method="post">
				...
				<div class="form-group row">
				  ...
				  <div class="col-xs-8">
					<input class="form-control" type="text" name="slot" value="<?php echo $slot;?>" id="example-time-input">
				  </div>
				</div>
				<div class="form-group row">
				  <label for="example-time-input" class="col-xs-4 col-form-label">Start Time:</label>
				  <div class="col-xs-8">
					<input class="form-control" type="time" name="start_time" value="<?php echo $start_time;?>" id="example-time-input">
				  </div>
				</div>
				<div class="form-group row">
				  <label for="example-time-input" class="col-xs-4 col-form-label">End Time:</label>
				  <div class="col-xs-8">
					<input class="form-control" type="time" name="end_time" value="<?php echo $end_time;?>" id="example-time-input">
				  </div>
				</div>
				</div>
				</div>
				<div class="form-group">
				<button for="example-time-input" type="submit" name="form_routine" class="col-xs-3 btn btn-success">Update</button>
				</div>
				</form>
			</div>
		</div>
