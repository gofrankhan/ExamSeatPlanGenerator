	...
	<!-- lEFT LIST START -->
			...
			<div class="col-md-9 col-sm-4">
				<table class="table table-striped">
					<thead>
						<tr>
							<th><h2>Final/Midterm Exammination</h2></th>
						</tr>
					</thead>
					<table class="table table-striped">
					<thead>
						...
						<tr>
						  <label for="example-date-input" class="col-xs-1 col-form-label">Date</label>
						  <div class="col-xs-4">
							<input class="form-control" type="date" name="date_search" value="2016-06-21" id="example-date-input">
							</div>
						</tr>
						<tr>
						  <label for="example-time-input" class="col-xs-1 col-form-label">Start Time</label>
						  <div class="col-xs-4">
							<input class="form-control" type="time" name="time_search" value="15:00" id="example-time-input">
						  </div>
						  </tr>
						  <div class="form-group">
							<button for="example-time-input" type="submit" name="search" class="col-xs-2 btn btn-success">Search</button>
						  </div>
						</div>
						</form> 
					</thead>
					...
					<table class="table table-striped">
						<tbody>
							<tr>
								...
								<td><b>Start Time: <?php echo $start_time?> </b></td>
							</tr>
						</tbody>
					</table>
					<?php
				...
				<?php
					...
					foreach($r_time as $row_time)
					{
						...
						foreach($r_course as $row_course)
						{
							...
							$stat = $db->prepare("select status from tb_block_room where room_no=?");
							 ...
							 if($row['col_1'] > 0 && $std_reg > 0){
										 ...
										 if($row['col_1'] > 0 ) 
													if ( $std_reg  > 0 && $c1 < $row['col_1']) {
															//echo $c1." ";
															if(strpos($c2_course, $course_id) === false ){
											  ...
											  if($row['col_2'] > 0 )
												    if ( $std_reg > 0 && $c2 < $row['col_2']) { 
															if(strpos($c1_course ,$course_id) === false) if (strpos($c3_course, $course_id)=== false){
															//echo $c2." ";
											  ...
											  if($row['col_3'] > 0 ) 
													if ( $std_reg > 0 && $c3 < $row['col_3']) { 
															//echo $c3." ";
															if(strpos($c2_course ,$course_id)=== false) if (strpos($c4_course, $course_id)=== false){
											  ...
											  if($row['col_4'] > 0 ) 
													if ( $std_reg > 0 && $c4 < $row['col_4']) { 
															//echo $c4." ";
															if(strpos($c3_course ,$course_id)=== false) if (strpos($c5_course, $course_id)=== false){
											  ...
											  if($row['col_5'] > 0 ) 
													if ( $std_reg > 0 && $c5 < $row['col_5']) { 
															//echo $c5." ";
															if(strpos($c4_course ,$course_id)=== false) if (strpos($c6_course, $course_id)=== false){
											  ...
											  if($row['col_6'] > 0 ) 
													if ( $std_reg > 0 && $c6 < $row['col_6']) { 
															//echo $c6." ";
															if(strpos($c5_course ,$course_id)=== false) if (strpos($c7_course, $course_id)=== false){
											  ...
											  if($row['col_7'] > 0 ) 
													if ( $std_reg > 0 && $c7 < $row['col_7']) 
														{ 
															//echo $c7." ";
															if(strpos($c6_course ,$course_id)=== false) if (strpos($c8_course, $course_id)=== false)
															{
											  ...
											  if($row['col_8'] > 0 ) 
													if ( $std_reg > 0 && $c8 < $row['col_8']) {
															//echo $c8." ";	
															if(strpos($c7_course ,$course_id) === false) if(strpos($c9_course, $course_id) === false){
											  ...
											  if($row['col_9'] > 0 ) 
													if ( $std_reg > 0 && $c9 < $row['col_9']) { 
															//echo $c9." ";
															if(strpos($c8_course, $course_id)=== false){
					...
					<tbody>
						...
						<?php	$statname = $db->prepare("select * from tb_room_course_name where room_no=?  and date=? and time=?");
								...
								foreach($resultname as $rowname)
								{
							      ...
							      if($row['c1'] > 0) echo "<td>".$rowname['c1']."</td>";
								  if($row['c2'] > 0) echo "<td>".$rowname['c2']."</td>";
								  if($row['c3'] > 0) echo "<td>".$rowname['c3']."</td>";
								  if($row['c4'] > 0) echo "<td>".$rowname['c4']."</td>";
								  if($row['c5'] > 0) echo "<td>".$rowname['c5']."</td>";
								  if($row['c6'] > 0) echo "<td>".$rowname['c6']."</td>";
								  if($row['c7'] > 0) echo "<td>".$rowname['c7']."</td>";
								  if($row['c8'] > 0) echo "<td>".$rowname['c8']."</td>";
								  if($row['c9'] > 0) echo "<td>".$rowname['c9']."</td>";
								}
								?>
						</tr>
						<tr>
						...
						<?php	$stattech = $db->prepare("select * from tb_room_tech_name where room_no=?  and date=? and time=?");
								...
								foreach($resulttech as $rowtech)
								{ 
								  if($row['c1'] > 0) echo "<td>".$rowtech['c1']."</td>";
								  if($row['c2'] > 0) echo "<td>".$rowtech['c2']."</td>";
								  if($row['c3'] > 0) echo "<td>".$rowtech['c3']."</td>";
								  if($row['c4'] > 0) echo "<td>".$rowtech['c4']."</td>";
								  if($row['c5'] > 0) echo "<td>".$rowtech['c5']."</td>";
								  if($row['c6'] > 0) echo "<td>".$rowtech['c6']."</td>";
								  if($row['c7'] > 0) echo "<td>".$rowtech['c7']."</td>";
								  if($row['c8'] > 0) echo "<td>".$rowtech['c8']."</td>";
								  if($row['c9'] > 0) echo "<td>".$rowtech['c9']."</td>";
								}
								?>
						...
						<?php   $statstr = $db->prepare("select * from tb_room_column_str where room_no=?  and date=? and time=?");
								...
								foreach($resultstr as $rowstr)
								{ 
             					  if($row['c1'] > 0) echo "<td>".$rowstr['c1']."</td>";
								  if($row['c2'] > 0) echo "<td>".$rowstr['c2']."</td>";
								  if($row['c3'] > 0) echo "<td>".$rowstr['c3']."</td>";
								  if($row['c4'] > 0) echo "<td>".$rowstr['c4']."</td>";
								  if($row['c5'] > 0) echo "<td>".$rowstr['c5']."</td>";
								  if($row['c6'] > 0) echo "<td>".$rowstr['c6']."</td>";
								  if($row['c7'] > 0) echo "<td>".$rowstr['c7']."</td>";
								  if($row['c8'] > 0) echo "<td>".$rowstr['c8']."</td>";
								  if($row['c9'] > 0) echo "<td>".$rowstr['c9']."</td>";
								}
							 ?>
						</tr>
					</tbody>
